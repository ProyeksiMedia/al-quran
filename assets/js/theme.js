								...
								'<div class="panel-body">',
									'<form>',
										'<div class="current-user text-center">',
											'<img id="LockUserPicture" src="'+userinfo.picture+'" alt="'+userinfo.username+'" class="img-circle user-image" />',
											'<h2 id="LockUserName" class="user-name text-dark m-none">'+userinfo.username+'</h2>',
											'<p  id="LockUserEmail" class="user-email m-none">'+userinfo.email+'</p>',
										'</div>',
										...
										'<div class="row">',
											'<div class="col-xs-8">',
												'<p class="mt-xs mb-none">',
													'<a href="#">Bukan '+userinfo.username+' ?</a>',
												'</p>',
											'</div>',
